...
def print_report():
    ...
    # print(MNB_model.predict_proba(test_X_bag_of_words))
...
if __name__ == '__main__':
    ...
    clf = MultinomialNB()
    MNB_model = clf.fit(train_X_bag_of_words, valid_train_y)

    # predict and print results
    predicted_y = MNB_model.predict(test_X_bag_of_words)
