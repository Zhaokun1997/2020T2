...
B = Variable("Burglary", boolean)
E = Variable("Earthquake", boolean)
A = Variable("Alarm", boolean)
J = Variable("John Calls", boolean)
M = Variable("Mary Calls", boolean)

f_B = Prob(B, [], [0.999, 0.001])
f_E = Prob(E, [], [0.998, 0.002])
f_A = Prob(A, [B, E], [0.999, 0.001, 0.71, 0.29, 0.06, 0.94, 0.05, 0.95])
f_J = Prob(J, [A], [0.95, 0.05, 0.1, 0.9])
f_M = Prob(M, [A], [0.99, 0.01, 0.3, 0.7])

bn4 = Belief_network([B, E, A, J, M], [f_B, f_E, f_A, f_J, f_M])
